      ...
      >
        ...
        <section
          ...
          style={{
            ...
            boxShadow:
              "0 12px 35px rgba(23,76,59,0.08)",
        ...
        >
          <span
            className="gallery-sparkle sparkle-one"
          >
            ✨
          </span>

          <span
            className="gallery-sparkle sparkle-two"
          >
            ⭐
          </span>
          ...
          >
            هنا نحتفي بالمحاولة والإبداع والتطور،
            ونشارك الأعمال التي راجعها المعلم
            واعتمد نشرها.
          </p>
        </section>
                      ...
                      return (
                        <article
                          ...
                          style={{
                            ...
                            boxShadow:
                              isFeatured
                                ? "0 20px 48px rgba(196,145,20,0.22)"
                          ...
                          {isFeatured && (
                            <div
                              style={{
                                ...
                                background:
                                  "linear-gradient(135deg, #fff2a8, #f7c948)",
                          ...
                          {isNewest && (
                            <div
                              ...
                              style={{
                                ...
                                background:
                                  "linear-gradient(135deg, #f6c453, #ffdf7d)",
                          ...
                          >
                            ...
                            >
                              <StudentIdentity
                                ...
                                personalPhotoUrl={
                                  work.personalPhotoUrl
                                }
                                selectedAvatarIcon={
                                  work.selectedAvatarIcon
                                }
                              />
                            </div>
        ...
        {activeGalleryTab ===
          ...
          <section
            style={{
              background:
                "linear-gradient(135deg, #fffaf0, #f0fbf6)",
              ...
              boxShadow:
                "0 12px 30px rgba(147,107,18,.08)",
            }}
          >
            <div
              style={{
            ...
            {!notebookLoading &&
              notebookItems.length ===
                ...
                >
                  📒 لم تُنشر صور دفاتر بعد...
                  أول دفتر جميل سيظهر هنا ✨
                </div>
              )}
                      ...
                      return (
                        <article
                          ...
                          style={{
                            ...
                            boxShadow:
                              "0 14px 32px rgba(120,95,25,0.10)",
                          }}
                        >
                          <img
                            src={
        ...
        >
          🛡️{" "}
          <strong>
            خصوصية طلابنا محفوظة
          </strong>

          <br />

          لا يظهر أي عمل هنا إلا بعد مراجعته
          واعتماده للنشر.
        </section>
      </div>
