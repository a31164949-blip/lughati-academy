...
export default function LoginPage() {
  ...
  /*
    =====================================================
    تحميل الفصول فقط عند فتح الصفحة
    =====================================================
  */
  useEffect(() => {
    let active =
      ...
      try {
        ...
        if (
          ...
          throw new Error(
            response.status ===
              404
              ? "مسار تحميل الفصول غير موجود في النسخة المنشورة."
              : `تعذر تحميل الفصول من الخادم. رمز الخطأ: ${response.status}`
          );
        }
        ...
        setMessage(
          error instanceof Error
            ? error.message
            : "تعذر تحميل الفصول، حاول مرة أخرى."
        );
      } finally {
        if (active) {
          setLoadingClassrooms(
  ...
  /*
    =====================================================
    اختيار الفصل ثم تحميل طلابه فقط
    =====================================================
  */
  async function handleClassChange(
    ...
    try {
      ...
      if (
        ...
        console.error(
          "المسار /api/students لم يُرجع JSON عند تحميل طلاب الفصل:",
          response.status,
          responseText.slice(
            0,
            300
        ...
        throw new Error(
          `تعذر تحميل طلاب الفصل. رمز الخطأ: ${response.status}`
        );
      }
      ...
      setMessage(
        error instanceof Error
          ? error.message
          : "تعذر تحميل طلاب الفصل، حاول مرة أخرى."
      );
    } finally {
      setLoadingStudents(
        false
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            رمز الدخول خاص بالطالب
            ولا ينبغي مشاركته مع الآخرين.
          </p>
...
> = {
  ...
  farisEmoji: {
    ...
    boxShadow:
      "0 6px 16px rgba(22, 101, 52, 0.10)",
  },
