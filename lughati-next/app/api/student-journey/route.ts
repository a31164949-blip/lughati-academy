...
/**
 * مهام اليوم الموثقة:
 * 1: تسجيل دقيقة قراءة، ولا تُعد منجزة إلا بعد اعتماد المعلم.
 * 2: إنجاز واجب اليوم، ولا يُعد منجزًا إلا بعد اعتماد المعلم.
 *
 * لا توجد نقاط أو سلسلة إنجاز لمجرد الضغط على أي زر.
 * جميع النقاط تأتي من مسارات الاعتماد الرسمية.
 */
const tasks = [
  {
    id: 1,
